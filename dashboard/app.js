...
function renderRank() {
  ...
  document.getElementById('ranktable').innerHTML =
    ...
    '<th>Gap (pp)</th><th>No-show</th><th>Ghosts/dep</th><th>Sold out</th></tr></thead>' +
    `<tbody>${body}</tbody>`;
...
function renderActions() {
  ...
  document.getElementById('actwindow').textContent =
    '1 January - 31 August 2026, weekdays \u00b7 ' + all.length + ' of ' + D.services.length + ' departures';
  ...
  document.getElementById('actrule').innerHTML = state.action === 'all'
  ...
  document.getElementById('acttable').innerHTML =
    ...
    '<th>Sold out</th><th>Refused/dep' + MODELLED + '</th><th>Ghosts/dep</th>' +
